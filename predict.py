...
modelFullPath = '/home/kristofer/Documents/malaria-mask/output_graph.pb'
labelsFullPath = '/home/kristofer/Documents/malaria-mask/output_labels.txt'
...
if __name__ == '__main__':
    ...
    fn = 0
    for f in files:
        ans = run_inference_on_image('/home/kristofer/Documents/malaria-mask/test/falciparum/' + f)
        if ans == 'falciparum':
            tp = tp + 1
        else:
            fn = fn + 1
    ...
    fp = 0
    for f in files:
        ans = run_inference_on_image('/home/kristofer/Documents/malaria-mask/test/non-falciparum/' + f)
